...
class List(ScrollArea):
    ...
    def _change_silently(self, value):
        self.value = value
    ...
    def remove(self, label, image = None, value=None):
        self._remove(self, label, image, value);
