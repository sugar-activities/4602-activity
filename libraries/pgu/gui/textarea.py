...
class TextArea(widget.Widget):
	...
	def paint(self,s):
		...
		# TODO: What's up with this 20 magic number? 
		# It's the margin of the left and right sides,
		# but I'm not sure how this should be gotten other than by trial and error.
		...
		if self.container and self.container().myfocus and self.container().myfocus() is self:
